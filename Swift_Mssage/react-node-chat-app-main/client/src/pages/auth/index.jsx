import Background from "../../assets/Swift-login.jpeg";
          ...
          <div className="flex items-center justify-center w-full ">
            <Tabs defaultValue="login" className="w-3/4">
              ...
              <TabsContent value="login" className="flex flex-col gap-5">
                ...
                />
                <Button className="rounded-full p-6 bg-purple-700" onClick={handleLogin}>
                  Login
                </Button>
              </TabsContent>
              <TabsContent value="signup" className="flex flex-col gap-3">
                ...
                />
                <Button className="rounded-full p-6 bg-purple-700" onClick={handleSignup}>
                  Signup
                </Button>
              </TabsContent>
            </Tabs>
